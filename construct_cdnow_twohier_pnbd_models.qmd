...
pnbd_cdnow_twohiermean_stanfit$summary()
```
...
pnbd_cdnow_twohierlambda_stanfit$summary()
```
...
model_assess_tbl <- dir_ls("data", regexp = "pnbd_cdnow_(fixed|one|two).*_assess_.*simstats") |>
