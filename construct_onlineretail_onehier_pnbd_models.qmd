...
```{r fit_pnbd_onlineretail_onehierlambda1_stanmodel}
#| echo: TRUE
...
pnbd_onlineretail_onehierlambda1_stanfit$summary()
```


We have some basic HMC-based validity statistics we can check.

```{r calculate_pnbd_onlineretail_onehierlambda1_hmc_diagnostics}
#| echo: TRUE
...
```{r plot_pnbd_onlineretail_onehierlambda1_lambda_traceplots_nowarmup}
#| echo: TRUE
...
```{r plot_pnbd_onlineretail_onehierlambda1_parameter_neffratio}
#| echo: TRUE
...
```{r run_pnbd_onlineretail_onehierlambda1_assessment}
#| echo: TRUE
...
```{r run_pnbd_onlineretail_onehierlambda1_fit_assessment}
#| echo: TRUE
...
```{r run_pnbd_onlineretail_onehierlambda1_valid_assessment}
#| echo: TRUE
...
```{r fit_pnbd_onlineretail_onehierlambda2_stanmodel}
#| echo: TRUE
...
pnbd_onlineretail_onehierlambda2_stanfit$summary()
```


We have some basic HMC-based validity statistics we can check.

```{r calculate_pnbd_onlineretail_onehierlambda2_hmc_diagnostics}
#| echo: TRUE
...
```{r plot_pnbd_onlineretail_onehierlambda2_lambda_traceplots_nowarmup}
#| echo: TRUE
...
```{r plot_pnbd_onlineretail_onehierlambda2_parameter_neffratio}
#| echo: TRUE
...
```{r run_pnbd_onlineretail_onehierlambda2_assessment}
#| echo: TRUE
...
```{r run_pnbd_onlineretail_onehierlambda2_fit_assessment}
#| echo: TRUE
...
```{r run_pnbd_onlineretail_onehierlambda2_valid_assessment}
#| echo: TRUE
...
```{r fit_pnbd_onlineretail_onehiermu1_stanmodel}
#| echo: TRUE
...
pnbd_onlineretail_onehiermu1_stanfit$summary()
```


We have some basic HMC-based validity statistics we can check.

```{r calculate_pnbd_onlineretail_onehiermu1_hmc_diagnostics}
#| echo: TRUE
...
```{r plot_pnbd_onlineretail_onehiermu1_lambda_traceplots_nowarmup}
#| echo: TRUE
...
```{r plot_pnbd_onlineretail_onehiermu1_parameter_neffratio}
#| echo: TRUE
...
```{r run_pnbd_onlineretail_onehiermu1_assessment}
#| echo: TRUE
...
```{r run_pnbd_onlineretail_onehiermu1_fit_assessment}
#| echo: TRUE
...
```{r run_pnbd_onlineretail_onehiermu1_valid_assessment}
#| echo: TRUE
...
```{r fit_pnbd_onlineretail_onehiermu2_stanmodel}
#| echo: TRUE
...
pnbd_onlineretail_onehiermu2_stanfit$summary()
```


We have some basic HMC-based validity statistics we can check.

```{r calculate_pnbd_onlineretail_onehiermu2_hmc_diagnostics}
#| echo: TRUE
...
```{r plot_pnbd_onlineretail_onehiermu2_lambda_traceplots_nowarmup}
#| echo: TRUE
...
```{r plot_pnbd_onlineretail_onehiermu2_parameter_neffratio}
#| echo: TRUE
...
```{r run_pnbd_onlineretail_onehiermu2_assessment}
#| echo: TRUE
...
```{r run_pnbd_onlineretail_onehiermu2_fit_assessment}
#| echo: TRUE
...
```{r run_pnbd_onlineretail_onehiermu2_valid_assessment}
#| echo: TRUE
