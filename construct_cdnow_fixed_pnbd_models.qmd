...
open_syslog("construct_cdnow_fixed_pnbd_models")
...
use_fit_end_date   <- as.Date("1997-12-01")
...
stan_modelname <- "pnbd_cdnow_fixed"
...
if(!file_exists(stanfit_object_file)) {
  ...
  pnbd_cdnow_fixed1_stanfit$save_object(stanfit_object_file)
...
```{r write_pnbd_cdnow_fixed1_assessment_data}
#| echo: TRUE

assess_data_lst$model_simstats_tbl |>
  write_rds("data/pnbd_cdnow_fixed1_assess_model_simstats_tbl.rds")

assess_data_lst$model_fit_simstats_tbl |>
  write_rds("data/pnbd_cdnow_fixed1_assess_fit_simstats_tbl.rds")

assess_data_lst$model_valid_simstats_tbl |>
  write_rds("data/pnbd_cdnow_fixed1_assess_valid_simstats_tbl.rds")
...
if(!file_exists(stanfit_object_file)) {
  ...
  pnbd_cdnow_fixed2_stanfit$save_object(stanfit_object_file)
...
assess_data_lst <- run_model_assessment(
  model_stanfit    = pnbd_cdnow_fixed2_stanfit,
  insample_tbl     = customer_fit_stats_tbl,
  outsample_tbl    = customer_valid_stats_tbl,
...
```{r write_pnbd_cdnow_fixed2_assessment_data}
#| echo: TRUE

assess_data_lst$model_simstats_tbl |>
  write_rds("data/pnbd_cdnow_fixed2_assess_model_simstats_tbl.rds")

assess_data_lst$model_fit_simstats_tbl |>
  write_rds("data/pnbd_cdnow_fixed2_assess_fit_simstats_tbl.rds")

assess_data_lst$model_valid_simstats_tbl |>
  write_rds("data/pnbd_cdnow_fixed2_assess_valid_simstats_tbl.rds")
...
if(!file_exists(stanfit_object_file)) {
  ...
  pnbd_cdnow_fixed3_stanfit$save_object(stanfit_object_file)
...
assess_data_lst <- run_model_assessment(
  model_stanfit    = pnbd_cdnow_fixed3_stanfit,
  insample_tbl     = customer_fit_stats_tbl,
  outsample_tbl    = customer_valid_stats_tbl,
...
```{r write_pnbd_cdnow_fixed3_assessment_data}
#| echo: TRUE

assess_data_lst$model_simstats_tbl |>
  write_rds("data/pnbd_cdnow_fixed3_assess_model_simstats_tbl.rds")

assess_data_lst$model_fit_simstats_tbl |>
  write_rds("data/pnbd_cdnow_fixed3_assess_fit_simstats_tbl.rds")

assess_data_lst$model_valid_simstats_tbl |>
  write_rds("data/pnbd_cdnow_fixed3_assess_valid_simstats_tbl.rds")
...
if(!file_exists(stanfit_object_file)) {
  ...
  pnbd_cdnow_fixed4_stanfit$save_object(stanfit_object_file)
...
assess_data_lst <- run_model_assessment(
  model_stanfit    = pnbd_cdnow_fixed4_stanfit,
  insample_tbl     = customer_fit_stats_tbl,
  outsample_tbl    = customer_valid_stats_tbl,
...
```{r write_pnbd_cdnow_fixed4_assessment_data}
#| echo: TRUE

assess_data_lst$model_simstats_tbl |>
  write_rds("data/pnbd_cdnow_fixed4_assess_model_simstats_tbl.rds")

assess_data_lst$model_fit_simstats_tbl |>
  write_rds("data/pnbd_cdnow_fixed4_assess_fit_simstats_tbl.rds")

assess_data_lst$model_valid_simstats_tbl |>
  write_rds("data/pnbd_cdnow_fixed4_assess_valid_simstats_tbl.rds")
