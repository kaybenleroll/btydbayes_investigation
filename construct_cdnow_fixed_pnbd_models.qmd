...
```{r calculate_pnbd_cdnow_fixed1_fit_assessment}
#| echo: TRUE
...
assess_data_lst |> write_rds("data/pnbd_cdnow_fixed1_data.rds")
```
...
assess_data_lst |> write_rds("data/pnbd_cdnow_fixed2_data.rds")
```
...
assess_data_lst |> write_rds("data/pnbd_cdnow_fixed3_data.rds")
```
...
```{r calculate_pnbd_cdnow_fixed4_fit_assessment}
#| echo: TRUE
...
assess_data_lst |> write_rds("data/pnbd_cdnow_fixed4_data.rds")
```
