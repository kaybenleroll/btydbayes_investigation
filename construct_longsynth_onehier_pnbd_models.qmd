---
title: "Construct Single-Hierarchical P/NBD Model for Long Timeframe Synthetic Data"
...
id_1000  <- read_rds("data/longframe_id_1000.rds")
id_5000  <- read_rds("data/longframe_id_5000.rds")
id_10000 <- read_rds("data/longframe_id_10000.rds")
...
```{r fit_pnbd_long_onehierlambda1_stanmodel}
#| echo: TRUE
#| cache: TRUE
...
pnbd_long_onehierlambda1_stanfit$summary()
```


We have some basic HMC-based validity statistics we can check.

```{r calculate_pnbd_long_onehierlambda1_hmc_diagnostics}
#| echo: TRUE
...
```{r plot_pnbd_long_onehierlambda1_lambda_traceplots_nowarmup}
#| echo: TRUE
...
```{r plot_pnbd_long_onehierlambda1_parameter_neffratio}
#| echo: TRUE
...
```{r run_pnbd_long_onehierlambda1_assessment}
#| echo: TRUE
...
```{r run_pnbd_long_onehierlambda1_fit_assessment}
#| echo: TRUE
...
```{r run_pnbd_long_onehierlambda1_valid_assessment}
#| echo: TRUE
...
```{r fit_pnbd_long_onehierlambda2_stanmodel}
#| echo: TRUE
#| cache: TRUE
...
pnbd_long_onehierlambda2_stanfit$summary()
```


We have some basic HMC-based validity statistics we can check.

```{r calculate_pnbd_long_onehierlambda2_hmc_diagnostics}
#| echo: TRUE
...
```{r plot_pnbd_long_onehierlambda2_lambda_traceplots_nowarmup}
#| echo: TRUE
...
```{r plot_pnbd_long_onehierlambda2_parameter_neffratio}
#| echo: TRUE
...
```{r run_pnbd_long_onehierlambda2_assessment}
#| echo: TRUE
...
```{r run_pnbd_long_onehierlambda2_fit_assessment}
#| echo: TRUE
...
```{r run_pnbd_long_onehierlambda2_valid_assessment}
#| echo: TRUE
...
```{r fit_pnbd_long_onehiermu1_stanmodel}
#| echo: TRUE
#| cache: TRUE
...
pnbd_long_onehiermu1_stanfit$summary()
```


We have some basic HMC-based validity statistics we can check.

```{r calculate_pnbd_long_onehiermu1_hmc_diagnostics}
#| echo: TRUE
...
```{r plot_pnbd_long_onehiermu1_lambda_traceplots_nowarmup}
#| echo: TRUE
...
```{r plot_pnbd_long_onehiermu1_parameter_neffratio}
#| echo: TRUE
...
```{r run_pnbd_long_onehiermu1_assessment}
#| echo: TRUE
...
```{r run_pnbd_long_onehiermu1_fit_assessment}
#| echo: TRUE
...
```{r run_pnbd_long_onehiermu1_valid_assessment}
#| echo: TRUE
...
```{r fit_pnbd_long_onehiermu2_stanmodel}
#| echo: TRUE
#| cache: TRUE
...
pnbd_long_onehiermu2_stanfit$summary()
```


We have some basic HMC-based validity statistics we can check.

```{r calculate_pnbd_long_onehiermu2_hmc_diagnostics}
#| echo: TRUE
...
```{r plot_pnbd_long_onehiermu2_lambda_traceplots_nowarmup}
#| echo: TRUE
...
```{r plot_pnbd_long_onehiermu2_parameter_neffratio}
#| echo: TRUE
...
```{r run_pnbd_long_onehiermu2_assessment}
#| echo: TRUE
...
```{r run_pnbd_long_onehiermu2_fit_assessment}
#| echo: TRUE
...
```{r run_pnbd_long_onehiermu2_valid_assessment}
#| echo: TRUE
...
model_assess_tbl <- dir_ls("data", regexp = "pnbd_long_.*_assess") |>
  enframe(name = NULL, value = "file_path") |>
  filter(str_detect(file_path, "_assess_model_", negate = TRUE)) |>
  mutate(
    model_label = str_replace(file_path, "data/pnbd_long_(onehier.*?)_assess_.*", "\\1"),
