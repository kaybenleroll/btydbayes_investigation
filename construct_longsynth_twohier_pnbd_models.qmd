...
pnbd_long_twohiermean_stanfit$summary()
```
...
pnbd_long_twohierlambda_stanfit$summary()
```
...
model_assess_tbl <- dir_ls("data", regexp = "pnbd_long_(fixed|one|two).*_assess_.*simstats") |>
