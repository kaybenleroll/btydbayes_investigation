...
rawdata_tbl <- read_rds("data/synthdata_shortframe_transactions_tbl.rds")
...
customer_transactions_tbl <- data_tbl |>
  mutate(
    customer_id = customer_id |> as_factor()
    )
...
id_1000  |> write_rds("data/shortsynth_id_1000.rds")
id_5000  |> write_rds("data/shortsynth_id_5000.rds")
id_10000 |> write_rds("data/shortsynth_id_10000.rds")

fit_1000_data_tbl  |> write_rds("data/shortsynth_fit_1000_data_tbl.rds")
fit_10000_data_tbl |> write_rds("data/shortsynth_fit_10000_data_tbl.rds")
