...
data_tbl <- data_tbl |>
  mutate(
    ...
    tnx_week  = format(tnx_timestamp, "%W"),
...
customer_id_lookup_tbl <- customer_transactions_tbl |>
  select(customer_id, orig_id) |>
  distinct()
...
customer_summarystats_tbl |> write_rds("data/shortsynth_customer_summarystats_tbl.rds")
