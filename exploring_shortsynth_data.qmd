...
```{r construct_model_fit_data}
#| echo: true

customer_fit_tnxdata_tbl <- btyd_transactions_tbl
customer_fit_tnxdata_tbl |> glimpse()

customer_fit_summarystats_tbl <- btyd_summarystats_tbl
customer_fit_summarystats_tbl |> glimpse()
```


```{r construct_model_validation_data}
#| echo: true

customer_valid_tnxdata_tbl <- customer_transactions_raw_tbl |>
  inner_join(
    customer_fit_summarystats_tbl |> select(customer_id, cust_id),
    by = "customer_id"
    ) |>
  filter(
...
customer_valid_summarystats_tbl <- customer_valid_tnxdata_tbl |>
  summarise(
    tnx_count = n(),
...
customer_fit_tnxdata_tbl |>
  write_rds("data/shortsynth_customer_fit_tnxdata_tbl.rds")

customer_fit_summarystats_tbl |>
  write_rds("data/shortsynth_customer_fit_summarystats_tbl.rds")

customer_valid_tnxdata_tbl |>
  write_rds("data/shortsynth_customer_valid_tnxdata_tbl.rds")

customer_valid_summarystats_tbl |>
  write_rds("data/shortsynth_customer_valid_summarystats_tbl.rds")
```
