...
pnbd_cdnow_onehierlambda1_stanfit$summary()
```
...
pnbd_cdnow_onehierlambda2_stanfit$summary()
```
...
pnbd_cdnow_onehiermu1_stanfit$summary()
```
...
pnbd_cdnow_onehiermu2_stanfit$summary()
```
