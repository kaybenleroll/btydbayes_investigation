---
title: "Construct Single-Hierarchical P/NBD Model for CD-Now Transaction Data"
...
```{r fit_pnbd_cdnow_onehierlambda1_stanmodel}
#| echo: TRUE
...
pnbd_cdnow_onehierlambda1_stanfit$print()
```


We have some basic HMC-based validity statistics we can check.

```{r calculate_pnbd_cdnow_onehierlambda1_hmc_diagnostics}
#| echo: TRUE

pnbd_cdnow_onehierlambda1_stanfit$cmdstan_diagnose()
```
...
```{r plot_pnbd_cdnow_onehierlambda1_lambda_traceplots_nowarmup}
#| echo: TRUE
...
```{r plot_pnbd_cdnow_onehierlambda1_parameter_neffratio}
#| echo: TRUE
...
```{r plot_pnbd_cdnow_onehierlambda1_energy}
#| echo: true
...
```{r run_pnbd_cdnow_onehierlambda1_assessment}
#| echo: TRUE
...
pnbd_cdnow_onehierlambda1_assess_data_lst |> glimpse()
```
...
```{r run_pnbd_cdnow_onehierlambda1_fit_assessment}
#| echo: TRUE
...
```{r run_pnbd_cdnow_onehierlambda1_valid_assessment}
#| echo: TRUE
...
```{r fit_pnbd_cdnow_onehierlambda2_stanmodel}
#| echo: TRUE
...
pnbd_cdnow_onehierlambda2_stanfit$print()
```


We have some basic HMC-based validity statistics we can check.

```{r calculate_pnbd_cdnow_onehierlambda2_hmc_diagnostics}
#| echo: TRUE

pnbd_cdnow_onehierlambda2_stanfit$cmdstan_diagnose()
```
...
```{r plot_pnbd_cdnow_onehierlambda2_lambda_traceplots_nowarmup}
#| echo: TRUE
...
```{r plot_pnbd_cdnow_onehierlambda2_parameter_neffratio}
#| echo: TRUE
...
```{r plot_pnbd_cdnow_onehierlambda2_energy}
#| echo: true
...
```{r run_pnbd_cdnow_onehierlambda2_assessment}
#| echo: TRUE
...
pnbd_cdnow_onehierlambda2_assess_data_lst |> glimpse()
```
...
```{r run_pnbd_cdnow_onehierlambda2_fit_assessment}
#| echo: TRUE
...
```{r run_pnbd_cdnow_onehierlambda2_valid_assessment}
#| echo: TRUE
...
```{r fit_pnbd_cdnow_onehiermu1_stanmodel}
#| echo: TRUE
...
pnbd_cdnow_onehiermu1_stanfit$print()
```


We have some basic HMC-based validity statistics we can check.

```{r calculate_pnbd_cdnow_onehiermu1_hmc_diagnostics}
#| echo: TRUE

pnbd_cdnow_onehiermu1_stanfit$cmdstan_diagnose()
```
...
```{r plot_pnbd_cdnow_onehiermu1_lambda_traceplots_nowarmup}
#| echo: TRUE
...
```{r plot_pnbd_cdnow_onehiermu1_parameter_neffratio}
#| echo: TRUE
...
```{r plot_pnbd_cdnow_onehiermu1_energy}
#| echo: true
...
```{r run_pnbd_cdnow_onehiermu1_assessment}
#| echo: TRUE
...
pnbd_cdnow_onehiermu1_assess_data_lst |> glimpse()
```
...
```{r run_pnbd_cdnow_onehiermu1_fit_assessment}
#| echo: TRUE
...
```{r run_pnbd_cdnow_onehiermu1_valid_assessment}
#| echo: TRUE
...
```{r fit_pnbd_cdnow_onehiermu2_stanmodel}
#| echo: TRUE
...
pnbd_cdnow_onehiermu2_stanfit$print()
```


We have some basic HMC-based validity statistics we can check.

```{r calculate_pnbd_cdnow_onehiermu2_hmc_diagnostics}
#| echo: TRUE

pnbd_cdnow_onehiermu2_stanfit$cmdstan_diagnose()
```
...
```{r plot_pnbd_cdnow_onehiermu2_lambda_traceplots_nowarmup}
#| echo: TRUE
...
```{r plot_pnbd_cdnow_onehiermu2_parameter_neffratio}
#| echo: TRUE
...
```{r plot_pnbd_cdnow_onehiermu2_energy}
#| echo: true
...
```{r run_pnbd_cdnow_onehiermu2_assessment}
#| echo: TRUE
...
pnbd_cdnow_onehiermu2_assess_data_lst |> glimpse()
```
...
```{r run_pnbd_cdnow_onehiermu2_fit_assessment}
#| echo: TRUE
...
```{r run_pnbd_cdnow_onehiermu2_valid_assessment}
#| echo: TRUE
...
model_assess_transactions_tbl <- dir_ls("data", regexp = "pnbd_cdnow_(fixed|one).*_assess_.*index") |>
...
model_assess_tbl |> write_rds("data/assess_data_pnbd_cdnow_onehier_tbl.rds")
```
