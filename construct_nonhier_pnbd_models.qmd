...
As before, we need to load a number of different sets of data.
...
```{r plot_pnbd_fixed_parameter_rhat}
#| echo: TRUE
...
```{r plot_pnbd_fixed_parameter_neffratio}
#| echo: TRUE
...
```{r plot_pnbd_fixed_parameter_acf}
#| echo: TRUE
...
```{r calculate_pnbd_fixed2_hmc_diagnostics}
#| echo: TRUE
...
```{r plot_pnbd_fixed2_parameter_neffratio}
#| echo: TRUE
...
```{r construct_pnbd_fixed2_validation_qvalues}
#| echo: TRUE
...
```{r construct_fixed_fixed2_comparison_data}
#| echo: TRUE
...
```{r calculate_pnbd_alive_summary_stats}
#| echo: TRUE
...
```{r plot_likely_active_transactions}
#| echo: TRUE
...
```{r plot_likely_active_transactions_2018}
#| echo: TRUE
...
```{r plot_likely_inactive_transactions}
#| echo: TRUE
...
```{r plot_distribution_p_alive_ranges}
#| echo: TRUE
...
```{r plot_pnbd_fixed_palive_uncertain_customers_transactions}
#| echo: TRUE
...
```{r generate_pnbd_fixed_validation_transactions}
#| echo: TRUE

plan(multisession)

model_label <- "pnbd_fixed"

precompute_dir <- glue("precompute/{model_label}")
...
pnbd_fixed_validsims_tbl <- pnbd_fixed_valid_lst$validation_tbl |>
  ...
  mutate(
    sim_file = glue(
      "{precompute_dir}/sims_{model_label}_{customer_id}.rds"
      ),
...
```{r calculate_validation_year_statistics}
#| echo: TRUE
...
```{r construct_pnbd_fixed_1000_validation_data}
#| echo: TRUE
...
```{r pnbd_fixed_validation_histogram}
#| echo: TRUE
...
```{r check_pnbd_fixed_1000_validation_zerocount_rows}
#| echo: TRUE
...
```{r investigate_pnbd_fixed_1000_validation_data}
#| echo: TRUE
...
customer `print(check_id)`.

```{r inspect_posterior_customer_first}
#| echo: TRUE
...
```{r inspect_posterior_customer_first_body}
#| echo: TRUE
...
```{r inspect_transactions_customer_first}
#| echo: TRUE
...
```{r check_pnbd_fixed2_customer_first_posterior}
#| echo: TRUE
...
```{r generate_pnbd_fixed2_validation_transactions}
#| echo: TRUE

model_label <- "pnbd_fixed2"
...
```{r construct_pnbd_fixed_tnx_simulations}
#| echo: TRUE
...
```{r construct_pnbd_fixed2_tnx_simulations}
#| echo: TRUE
...
```{r calculate_pnbd_fixed3_hmc_diagnostics}
#| echo: TRUE
...
```{r plot_pnbd_fixed3_parameter_neffratio}
#| echo: TRUE
...
```{r construct_pnbd_fixed3_posterior_data}
#| echo: TRUE
...
```{r check_pnbd_fixed3_customer_C201212_0330_posterior}
#| echo: TRUE
...
```{r generate_pnbd_fixed3_validation_sims}
#| echo: TRUE

model_label <- "pnbd_fixed3"
...
```{r construct_pnbd_fixed3_1000_validation_data}
#| echo: TRUE
...
```{r plot_pnbd_fixed3_qval_histogram}
#| echo: TRUE
...
```{r construct_pnbd_fixed3_tnx_simulations}
#| echo: TRUE
...
An improvement to this model would allow us to express uncertainty around these
prior parameters, allowing those values themselves to have probability
distributions, thereby enabling us to express our uncertainty more formally.

Building such 'hierarchical models' is the next step.

Before we move onto this though, we want to increase the data count, as this
may help resolve some of the identification issues with the lifetime parts of
the model.
