...
cust_id <- read_rds("data/shortframe_id_10000.rds")
...
pnbd_nonhier_fixed_validsims_tbl <- sim_stats_tbl |>
  ...
  mutate(
    ...
    chunk_data = future_map2(
      ...
      end_dttm   = as.POSIXct(use_fit_end_date),
...
pnbd_nonhier_fixed_validsims_tbl |> glimpse()
```
