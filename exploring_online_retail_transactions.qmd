...
customer_cohort_tbl     |> write_rds("data/retail_data_cohort_tbl.rds")

customer_tnx_data_tbl   |> write_rds("data/retail_data_transactions_tbl.rds")

daily_spend_invoice_tbl |> write_rds("data/retail_data_invoice_cleaned_tbl.rds")
