...
customer_fit_stats_tbl    <- read_rds("data/shortsynth_obs_fitdata_tbl.rds")
...
```{r fit_pnbd_init_short_fixed1_stanmodel}
#| echo: TRUE
...
pnbd_init_short_fixed1_simstats_tbl |>
  write_rds("data/pnbd_init_short_fixed1_assess_model_simstats_tbl.rds", compress = "gz")
```
...
pnbd_init_short_fixed1_fit_simstats_tbl |>
  write_rds("data/pnbd_init_short_fixed1_assess_fit_simstats_tbl.rds", compress = "gz")
```
...
pnbd_init_short_fixed1_valid_simstats_tbl |>
  write_rds("data/pnbd_init_short_fixed1_assess_valid_simstats_tbl.rds", compress = "gz")
```
...
pnbd_init_short_fixed2_simstats_tbl |>
  write_rds("data/pnbd_init_short_fixed2_assess_model_simstats_tbl.rds", compress = "gz")
```
...
pnbd_init_short_fixed2_fit_simstats_tbl |>
  write_rds("data/pnbd_init_short_fixed2_assess_fit_simstats_tbl.rds", compress = "gz")
```
...
pnbd_init_short_fixed2_valid_simstats_tbl |>
  write_rds("data/pnbd_init_short_fixed2_assess_valid_simstats_tbl.rds", compress = "gz")
```
...
pnbd_init_short_fixed3_simstats_tbl |>
  write_rds("data/pnbd_init_short_fixed3_assess_model_simstats_tbl.rds", compress = "gz")
```
...
pnbd_init_short_fixed3_fit_simstats_tbl |>
  write_rds("data/pnbd_init_short_fixed3_assess_fit_simstats_tbl.rds", compress = "gz")
```
...
pnbd_init_short_fixed3_fit_simstats_tbl |>
  write_rds("data/pnbd_init_short_fixed3_assess_valid_simstats_tbl.rds", compress = "gz")
```
...
```{r calculate_model_assessment_summary_stats}
#| echo: TRUE
...
model_assess_tbl |> write_rds("data/assess_data_pnbd_init_short_fixed_tbl.rds")
```
