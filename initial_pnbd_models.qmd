...
customer_id_lookup_tbl    <- read_rds("data/shortsynth_customer_id_lookup_tbl.rds")
customer_id_lookup_tbl    |> glimpse()
...
tnxamt_init_valid_tbl <- tnxamt_init_stanfit |>
  ...
  spread_draws(amt_mn[customer_id], amt_alpha[customer_id]) |>
  inner_join(
...
stan_data_lst <- customer_fit_stats_tbl |>
  select(cust_id = customer_id, x, t_x, T_cal) |>
  compose_data(
    lambda_mn = 0.25,
    lambda_cv = 1.00,
