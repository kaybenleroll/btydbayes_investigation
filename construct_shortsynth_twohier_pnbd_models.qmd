...
pnbd_short_twohiermean_stanfit$summary()
```
...
pnbd_short_twohierlambda_stanfit$summary()
```
...
model_assess_tbl <- dir_ls("data", regexp = "pnbd_short_(fixed|one|two).*_assess_.*simstats") |>
