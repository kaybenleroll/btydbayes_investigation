---
title: "Construct Non-Hierarchical P/NBD Model for Short Timeframe Synthetic Data"
...
open_syslog("construct_short_fixed_pnbd_models")
...
```{r fit_pnbd_short_fixed1_stanmodel}
#| echo: TRUE
...
pnbd_short_fixed1_stanfit$summary()
```


We have some basic HMC-based validity statistics we can check.

```{r calculate_pnbd_short_fixed1_hmc_diagnostics}
#| echo: TRUE
...
```{r plot_pnbd_short_fixed1_lambda_traceplots_nowarmup}
#| echo: TRUE
...
```{r plot_pnbd_short_fixed1_parameter_neffratio}
#| echo: TRUE
...
```{r calculate_pnbd_short_fixed1_assessment}
#| echo: TRUE
...
```{r run_pnbd_short_fixed1_fit_assessment}
#| echo: TRUE
...
```{r run_pnbd_short_fixed1_valid_assessment}
#| echo: TRUE
...
```{r delete_pnbd_short_fixed1_assessment}
#| echo: false
...
```{r calculate_pnbd_short_fixed2_assessment}
#| echo: TRUE
...
```{r delete_pnbd_short_fixed2_assessment}
#| echo: false
...
```{r fit_pnbd_short_fixed3_stanmodel}
#| echo: TRUE
...
pnbd_short_fixed3_stanfit$summary()
```


We have some basic HMC-based validity statistics we can check.

```{r calculate_pnbd_short_fixed3_hmc_diagnostics}
#| echo: TRUE
...
```{r plot_pnbd_short_fixed3_lambda_traceplots}
#| echo: TRUE
...
```{r plot_pnbd_short_fixed3_parameter_neffratio}
#| echo: TRUE
...
```{r calculate_pnbd_short_fixed3_assessment}
#| echo: TRUE
...
```{r run_pnbd_short_fixed3_fit_assessment}
#| echo: TRUE
...
```{r run_pnbd_short_fixed3_valid_assessment}
#| echo: TRUE
...
```{r delete_pnbd_short_fixed3_assessment}
#| echo: false
...
```{r calculate_pnbd_short_fixed4_assessment}
#| echo: TRUE
...
```{r delete_pnbd_short_fixed4_assessment}
#| echo: false
...
model_assess_tbl <- dir_ls("data", regexp = "pnbd_short_fixed.*_assess_.*simstats") |>
