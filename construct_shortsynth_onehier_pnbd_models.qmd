...
```{r fit_pnbd_init_short_onehierlambda1_stanmodel}
#| echo: TRUE
...
```{r calculate_pnbd_init_short_onehierlambda1_hmc_diagnostics}
#| echo: TRUE
...
```{r plot_pnbd_init_short_onehierlambda1_lambda_traceplots_nowarmup}
#| echo: TRUE
...
```{r plot_pnbd_init_short_onehierlambda1_parameter_neffratio}
#| echo: TRUE
...
```{r run_pnbd_init_short_onehierlambda1_assessment}
#| echo: TRUE

pnbd_stanfit <- pnbd_init_short_onehierlambda1_stanfit |>
...
```{r run_pnbd_init_short_onehierlambda1_fit_assessment}
#| echo: TRUE
...
```{r run_pnbd_init_short_onehierlambda1_valid_assessment}
#| echo: TRUE
...
```{r fit_pnbd_init_short_onehierlambda2_stanmodel}
#| echo: TRUE
...
```{r calculate_pnbd_init_short_onehierlambda2_hmc_diagnostics}
#| echo: TRUE
...
```{r plot_pnbd_init_short_onehierlambda2_lambda_traceplots_nowarmup}
#| echo: TRUE
...
```{r plot_pnbd_init_short_onehierlambda2_parameter_neffratio}
#| echo: TRUE
...
```{r run_pnbd_init_short_onehierlambda2_assessment}
#| echo: TRUE

pnbd_stanfit <- pnbd_init_short_onehierlambda2_stanfit |>
  recover_types(customer_fit_stats_tbl)
...
```{r run_pnbd_init_short_onehierlambda2_fit_assessment}
#| echo: TRUE
...
```{r run_pnbd_init_short_onehierlambda2_valid_assessment}
#| echo: TRUE
...
```{r fit_pnbd_init_short_onehiermu1_stanmodel}
#| echo: TRUE
...
```{r calculate_pnbd_init_short_onehiermu1_hmc_diagnostics}
#| echo: TRUE
...
```{r plot_pnbd_init_short_onehiermu1_lambda_traceplots_nowarmup}
#| echo: TRUE
...
```{r plot_pnbd_init_short_onehiermu1_parameter_neffratio}
#| echo: TRUE
...
```{r run_pnbd_init_short_onehiermu1_assessment}
#| echo: TRUE

pnbd_stanfit <- pnbd_init_short_onehiermu1_stanfit |>
  recover_types(customer_fit_stats_tbl)
...
```{r run_pnbd_init_short_onehiermu1_fit_assessment}
#| echo: TRUE
...
```{r run_pnbd_init_short_onehiermu1_valid_assessment}
#| echo: TRUE
...
```{r fit_pnbd_init_short_onehiermu2_stanmodel}
#| echo: TRUE
...
```{r calculate_pnbd_init_short_onehiermu2_hmc_diagnostics}
#| echo: TRUE
...
```{r plot_pnbd_init_short_onehiermu2_lambda_traceplots_nowarmup}
#| echo: TRUE
...
```{r plot_pnbd_init_short_onehiermu2_parameter_neffratio}
#| echo: TRUE
...
```{r run_pnbd_init_short_onehiermu2_assessment}
#| echo: TRUE

pnbd_stanfit <- pnbd_init_short_onehiermu2_stanfit |>
  recover_types(customer_fit_stats_tbl)
...
```{r run_pnbd_init_short_onehiermu2_fit_assessment}
#| echo: TRUE
...
```{r run_pnbd_init_short_onehiermu2_valid_assessment}
#| echo: TRUE
...
model_assess_tbl <- dir_ls("data", regexp = "pnbd_init_short_(one|fixed).*_assess_.*simstats") |>
...
model_assess_tbl |> write_rds("data/assess_data_pnbd_init_short_onehier_tbl.rds")
```
