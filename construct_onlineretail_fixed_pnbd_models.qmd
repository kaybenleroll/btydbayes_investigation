...
assess_data_lst |> write_rds("data/pnbd_onlineretail_fixed2_assess_data_lst.rds")
```
...
assess_data_lst |> write_rds("data/pnbd_onlineretail_fixed3_assess_data_lst.rds")
```
...
assess_data_lst |> write_rds("data/pnbd_onlineretail_fixed4_assess_data_lst.rds")
```
