...
pnbd_onlineretail_fixed1_assess_data_lst <- run_model_assessment(
  ...
  fit_end_dttm     = use_fit_end_date     |> as.POSIXct(tz = "UTC"),
  valid_start_dttm = use_valid_start_date |> as.POSIXct(tz = "UTC"),
  valid_end_dttm   = use_valid_end_date   |> as.POSIXct(tz = "UTC"),
  sim_seed         = 10
  )
...
model_assess_tbl <- dir_ls("data", regexp = "pnbd_onlineretail_fixed.*_assess") |>
