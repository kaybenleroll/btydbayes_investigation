...
if(!file_exists(stanfit_object_file)) {
  ...
  pnbd_long_fixed1_stanfit$save_object(stanfit_object_file)
...
assess_data_lst$model_simstats_tbl |>
  write_rds("data/pnbd_long_fixed1_assess_model_simstats_tbl.rds")

assess_data_lst$model_fit_simstats_tbl |>
  write_rds("data/pnbd_long_fixed1_assess_fit_simstats_tbl.rds")

assess_data_lst$model_valid_simstats_tbl |>
  write_rds("data/pnbd_long_fixed1_assess_valid_simstats_tbl.rds")
...
if(!file_exists(stanfit_object_file)) {
  ...
  pnbd_long_fixed2_stanfit$save_object(stanfit_object_file)
...
assess_data_lst$model_simstats_tbl |>
  write_rds("data/pnbd_long_fixed2_assess_model_simstats_tbl.rds")

assess_data_lst$model_fit_simstats_tbl |>
  write_rds("data/pnbd_long_fixed2_assess_fit_simstats_tbl.rds")

assess_data_lst$model_valid_simstats_tbl |>
  write_rds("data/pnbd_long_fixed2_assess_valid_simstats_tbl.rds")
...
if(!file_exists(stanfit_object_file)) {
  ...
  pnbd_long_fixed3_stanfit$save_object(stanfit_object_file)
...
```{r write_pnbd_long_fixed3_disk}
#| echo: TRUE

assess_data_lst$model_simstats_tbl |>
  write_rds("data/pnbd_long_fixed3_assess_model_simstats_tbl.rds")

assess_data_lst$model_fit_simstats_tbl |>
  write_rds("data/pnbd_long_fixed3_assess_fit_simstats_tbl.rds")

assess_data_lst$model_valid_simstats_tbl |>
  write_rds("data/pnbd_long_fixed3_assess_valid_simstats_tbl.rds")
