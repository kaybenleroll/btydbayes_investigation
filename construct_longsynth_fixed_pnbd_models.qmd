...
```{r fit_pnbd_long_fixed4_stanmodel}
#| echo: TRUE
#| cache: TRUE
...
```{r calculate_pnbd_long_fixed4_hmc_diagnostics}
#| echo: TRUE
...
```{r plot_pnbd_long_fixed4_lambda_traceplots}
#| echo: TRUE
...
```{r plot_pnbd_long_fixed4_parameter_neffratio}
#| echo: TRUE
...
```{r run_pnbd_long_fixed4_fit_assessment}
#| echo: TRUE
...
```{r run_pnbd_long_fixed4_valid_assessment}
#| echo: TRUE
