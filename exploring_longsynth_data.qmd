---
title: "Exploring the Synthetic Long-Timeframe Transaction Dataset"
...
rawdata_tbl <- read_rds("data/rawsynthdata_longframe_transactions_tbl.rds")
...
customer_cohort_data_tbl |>
  write_rds("data/longsynth_customer_cohort_data_tbl.rds")

customer_transactions_raw_tbl |>
  write_rds("data/longsynth_transaction_data_tbl.rds")
...
list(
  ...
  write_rds("data/longsynth_simulation_dates.rds")


id_1000  |> write_rds("data/longsynth_customer_subset_ids.rds")


customer_fit_tnxdata_tbl |>
  write_rds("data/longsynth_customer_fit_tnxdata_tbl.rds")

customer_fit_summarystats_tbl |>
  write_rds("data/longsynth_customer_fit_summarystats_tbl.rds")

customer_valid_tnxdata_tbl |>
  write_rds("data/longsynth_customer_valid_tnxdata_tbl.rds")

customer_valid_summarystats_tbl |>
  write_rds("data/longsynth_customer_valid_summarystats_tbl.rds")
```
